...
def append_sys_path():
    ...
    root = os.environ.get('MINIRTS_ROOT', '/workspace/minirts/')
    assert os.path.exists(root), 'minirts should be installed at `/workspace/minirts`'
    #root = os.environ['MINIRTS_ROOT']
    #assert os.path.exists(root), 'minirts should be installed at `/workspace/minirts`' + root
